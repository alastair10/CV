...
| [Find-a-Film](https://github.com/alastair10/Find-a-Film)    | A film search web app that lets users search for a film and quickly determine which platform offers it for streaming, rental, or purchase (e.g. Netflix, Prime Video, Disney+, etc.). Built to answer the question: What platform is [movie X] available on? Used the project as a way to reinforce knowledge in **React** and **asynchronous data requests** as well as a challenge to learn with new skills in **TypeScript**.              | 2 weeks              | TypeScript, React.js, Cypress, HTML & CSS                                                                                                    |
| [Acebook](https://github.com/alastair10/AceBook)        | A full-stack **MERN** social media app (facebook clone) our group built with Authorisation and Authentication, password encryption, and a clean UI. Users can ‘friend/unfriend’ other users, post comments, like comments, and select their avatar. This project was meant as an exercise to familiarise ourselves with an unknown (buggy) codebase and expose us to technologies with which we had little to no previous experience. | 2 weeks              | React.js, MongoDB, Node.js, Express.js, Cypress, HTML & CSS                                                                                  |
| [Bank Tech Test](https://github.com/alastair10/bank_tech_test) | Mock tech test to build a simple banking application using TDD, OOD principles, and best practices. (Reviewer feedback included.)                                                                                                                                                                                                                                                                                                 | 3 days               | Ruby, RSpec                                                                                                                                  |
| [MakersBnB](https://github.com/alastair10/MakersBnB)      | Slimmed-down web app that allows users to book spaces as well as rent out spaces they own.                                                                                                                                                                                                                                                                                                                                        | 1 week               | Ruby, Sinatra, PostgreSQL, HTML & CSS, Rspec, Twilio API                                                                                     |                                                                                |
