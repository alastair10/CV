...
|----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
| [Zero%Brews](https://www.zeropercentbrews.com/)     | An interactive full-stack **MERN** application which allows users to log in, search for, review, comment, upvote, and save a selection of non-alcoholic beers. Contributed heavily to ideation through development, including: handling API calls to fetch data from the server, building dynamic React components to render data, route creation using Express Router, database model design and hosting, and E2E testing with Cypress.                         | 2 weeks              | React.js, MongoDB, Node.js, Express.js, Cypress, HTML & CSS. Deployed on Vercel and Render (see [production](https://www.zeropercentbrews.com/) as well as [client](https://github.com/alastair10/ZeroPercentBrews-client) and [API](https://github.com/alastair10/ZeroPercentBrews-api) repos). |
| [Find-a-Film](https://github.com/alastair10/Find-a-Film)    | A film search web app that lets users search for a film, sort and filter results, and quickly determine which platform offers it for streaming, rental, or purchase (e.g. Netflix, Prime Video, Disney+, etc.). Built to answer the question: What platform is [movie X] available on? Used the project as a way to reinforce knowledge in **React** and **asynchronous data requests**, as well as a challenge to learn a new language: **TypeScript**.              | 2 weeks              | TypeScript, React.js, Cypress, HTML & CSS                                                                                                    |
| [Acebook](https://github.com/alastair10/AceBook)        | A full-stack **MERN** social media app (facebook clone) built with Authorisation and Authentication, password encryption, and a clean UI. Users can ‘friend/unfriend’ other users, post comments, like comments, and select their avatar. This project was meant as an exercise to familiarise ourselves with an unknown (buggy) codebase and expose us to technologies with which we had little to no previous experience. | 2 weeks              | React.js, MongoDB, Node.js, Express.js, Cypress, HTML & CSS                                                                                  |
| [Bank Tech Test](https://github.com/alastair10/bank_tech_test) | Mock tech test to build a simple banking application using TDD, OOD principles, and best practices. (Feedback on my code can be found [here](https://github.com/alastair10/bank_tech_test).)                                                                                                                                                                                                                                                                                                 | 3 days               | Ruby, RSpec                                                                                                                                  |
| [MakersBnB](https://github.com/alastair10/MakersBnB)      | CRUD application that allows users to book spaces as well as rent out spaces they own.                                                                                                                                                                                                                                                                                                                                        | 1 week               | Ruby, Sinatra, PostgreSQL, HTML & CSS, Rspec, Twilio API                                                                                     |                                                                                |
...
#### [Bowdoin College](https://www.bowdoin.edu/) - Brunswick, USA (2003 - 2007)  
...
My experience in the financial industry involved highly analytical tasks, working with large databases to analyse market and company data to drive a particular strategy or investment decision. Some examples include:
- Built several financial models that estimated valuations of acquisition targets and their potential return on investment. Built in scenario analysis to represent a range of macro market conditions and variables that could be dynamically altered.
- As an investment specialist, I would use ESG data, company financial information, and bond market data to analyse the performance of bond investments. Analysis was used by the investment committee when picking investments for client portfolios.

**Communication**  
Clear and effective communication was an essential part of my previous roles.
- As a portfolio impact manager, I was responsible for presenting strategic options and complex financial data to senior executives and potential investors at monthly and quarterly intervals. Presentations needed to tell a story about the data and include actionable insights that could be understood by both technical and non-technical teams.
- Delivered multiple presentations in front of internal stakeholders and clients. In some instances, negative news (poor investment performance) needed to be delivered so I learned how to manage client expectations and present in high pressure situations.

**Teamwork**  
I have extensive experience successfully working with people from diverse backgrounds in a variety of high pressure, team-based situations. Some examples include:
...
- Won the 2016 IESE Business School [Venture Capital Investment Competition](https://www.vcic.org/), as part of a four member multinational team with no prior venture capital experience. Competed against the entire business school and beat several teams with professional VC industry experience.
- Successfully delivered multiple projects as a member of several agile software development teams while at Makers. Also volunteered to complete an extra team project that was not part of the course: [Find-a-Film](https://github.com/alastair10/Find-a-Film).  
...
- Formula 1
- cosmology (or anything space-related!)
- Sports: football, and playing fantasy football (badly!), snowboarding, swimming
- Acoustic guitar
- Volunteering:
