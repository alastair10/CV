...
|----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
| [Zero%Brews](https://www.zeropercentbrews.com/)     | An interactive full-stack **MERN** application which allows users to log in, search for, review, comment, upvote, and save a selection of non-alcoholic beers. Contributed heavily to ideation through development, including: building backend REST APIs, route creation using Express Router, database model design and hosting, as well as building front end fetch requests and E2E testing with Cypress.                         | 2 weeks              | React.js, MongoDB, Node.js, Express.js, Cypress, HTML & CSS. Deployed on Vercel and Render (see [production](https://www.zeropercentbrews.com/) as well as [client](https://github.com/alastair10/ZeroPercentBrews-client) and [API](https://github.com/alastair10/ZeroPercentBrews-api) repos). |
