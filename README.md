...
|------------------|-----------------------------------------------------------------------------------------------------------------------------------|----------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
| [Zero%Brews](https://www.zeropercentbrews.com/)     | Web app for users to find, review, and save alcohol-free beers.                                                                             | 2 weeks              | React.js, MongoDB, Node.js, Express.js, Cypress, HTML & CSS. Deployed on Vercel and Render (see [production](https://www.zeropercentbrews.com/) as well as [client](https://github.com/alastair10/ZeroPercentBrews-client) and [API](https://github.com/alastair10/ZeroPercentBrews-api) repos). |
| [Find-a-Film](https://github.com/alastair10/Find-a-Film)    | Web app that lets users search for a film and quickly determine which platform offers it for streaming, rental, or purchase.      | 2 weeks              | TypeScript, React.js, Cypress, HTML & CSS                                                                                                    |
| [Acebook](https://github.com/alastair10/AceBook)        | MVP of a social media platform using an existing (buggy) code base.                                                               | 2 weeks              | React.js, MongoDB, Node.js, Express.js, Cypress, HTML & CSS                                                                                  |
